...
def main():
    ...
    plot_all(raw_dfs, unfiltered_raw_dfs, avg_tm_df, titration_df_ref, kd_results_agg, per_rep_results, args, show_all=args.show_all)
...
def plot_all(raw_dfs, unfiltered_raw_dfs, avg_tm_df, titration_df_ref, kd_results_agg, per_rep_results, args, show_all=False):
    ...
    plot_kds_per_rep(per_rep_results, args.protein, model=args.model, show=show_all)
